...
export default function ChatMensajeria({ currentUser }) {
  ...
  return (
    <div className="bg-neutral-900/80 border border-red-700/40 rounded-2xl p-3 mt-6 flex flex-col h-[320px] shadow-lg">
      <h4 className="text-red-400 font-semibold mb-2 text-sm text-center">
        💬 Canal de Comunicación — Coordinadores
      </h4>
      ...
      <form onSubmit={sendMessage} className="flex gap-2">
        <input
          ...
          className="flex-1 bg-black border border-neutral-700 rounded-lg px-3 py-1.5 text-sm"
        />
        <button
          type="submit"
